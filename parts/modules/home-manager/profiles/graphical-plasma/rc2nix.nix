{
  programs.plasma = {
    ...
    configFile = {
      ...
      "baloofilerc"."General"."exclude folders[$e]" = "$HOME/ProjectBundle/czichy/nixpkgs/,$HOME/Study/";
      ...
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."Image" = "file:///home/czichy/FiberBundle/Images/Wallpapers/Ultrawide/wallhaven-2y6w3m.png";
      "kscreenlockerrc"."Greeter/Wallpaper/org/kde/image/General"."Image" = "file:///home/czichy/FiberBundle/Images/Wallpapers/Ultrawide/wallhaven-2y6w3m.png";
      ...
      "kwinrc"."Effect-cube"."SkyBox" = "/home/czichy/FiberBundle/Images/Wallpapers/SpaceNebulae/772698.jpg";
