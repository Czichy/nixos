        ...
        net = mkOption {
          type = types.attrsOf (types.submodule (netSubmod: {
            options = {
              ...
              cidrv6 = mkOption {
                type = types.nullOr libNet.types.cidrv6;
                  ...
                  options = {
                    ...
                    ipv4 = mkOption {
                      ...
                      default =
                        ...
                        then null
                        else libNet.cidr.host hostSubmod.config.id netSubmod.config.cidrv4;
                    };
                    ...
                    ipv6 = mkOption {
                      ...
                      default =
                        ...
                        then null
                        else libNet.cidr.host hostSubmod.config.id netSubmod.config.cidrv6;
                    };
