      ...
      options = {
        server = {
          ...
          externalPeers = mkOption {
            type = types.attrsOf (types.listOf (localFlake.lib.net.types.ip-in config.addresses));
            default = {};
          ...
          reservedAddresses = mkOption {
            type = types.listOf localFlake.lib.net.types.cidr;
            default = [];
        ...
        ipv4 = mkOption {
          type = lazyOf localFlake.lib.net.types.ipv4;
          default = lazyValue (wireguard inputs name).assignedIpv4Addresses.${nodeName};
          description = ''
        ...
        ipv6 = mkOption {
          type = lazyOf localFlake.lib.net.types.ipv6;
          default = lazyValue (localFlake.lib.wireguard inputs name).assignedIpv6Addresses.${nodeName};
          description = ''
        ...
        addresses = mkOption {
          type = types.listOf (lazyOf localFlake.lib.net.types.ip);
          default = [
